...
import { AnimatedTooltip } from "@soloflow/ui/animated-tooltip";
import { BackgroundLines } from "@soloflow/ui/background-lines";
...
const people = [
  {
    ...
    link: "https://github.com/proxitek",
  },
  {
    id: 2,
    name: "Proxitek Studio",
    designation: "Design & UX",
    image: "https://avatars.githubusercontent.com/u/2",
    link: "https://proxitek.fr",
  },
  {
    id: 3,
    name: "Krigs",
            ...
            <BackgroundLines className="h-full">
              <div className="flex flex-col pt-4 md:pt-36 lg:pt-36 xl:pt-36">
                ...
                <div
                  ...
                  <Link href="https://github.com/Krigsexe/Proxitek-SoloFlow" target="_blank">
                    <Button
      ...
      <section className="container pt-24">
        <div className="flex flex-col justify-center items-center pt-10">
          ...
          <div className="mt-4 flex items-center gap-4">
            ...
            <Link href="https://ko-fi.com/krigsb" target="_blank">
